...
엄청 유명한 책이라 전부터 한 번 읽어봐야지 했다가 드디어 읽어봤다. 전에 읽었던 [레버리지](https://sooftware.github.io/leverage/) 와 비슷한 내용이 많았다. 비슷한 내용이지만 집중적으로 말하고 싶은 내용이 레버리지는 책 제목처럼 '레버리지(leverage)를 해라!'라면, '부의 추월차선'은 좀 더 '부'에 초점을 맞춰서 얘기하는 느낌이다.  
